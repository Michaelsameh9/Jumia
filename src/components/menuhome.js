...
export default function MenuHome() {
    return (
        <>
            <div className='toggle-menu0'>
                <Nav.Link href="/Supermarket" className='link-home'><CiApple className='icon-menu' />
                    <div className='toggle-men1'>
                        <div className='links'>
                            <ul>
